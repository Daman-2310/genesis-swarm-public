...
export default function Showcase() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#060a18] text-white">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        >
          Deterministic AIFMD II / UCITS compliance checking — every finding traceable to
          its source line and mapped to the exact article. Built for Conducting
        ...
        >
          {["AIFMD II 2011/61/EU", "DORA 2022/2554/EU", "CSSF 22/816"].map((t) => (
