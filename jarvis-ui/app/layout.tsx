...
export const metadata: Metadata = {
  ...
  description: 'Deterministic compliance tooling for European funds. It reads a fund prospectus and checks it against AIFMD II in the browser — no LLM, so every verdict is reproducible and re-verifiable. Open-source.',
