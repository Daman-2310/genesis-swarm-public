    ...
    <div className="min-h-screen text-white" style={{ background: 'radial-gradient(ellipse at top, #0a0a1a 0%, #050508 50%, #000 100%)' }}>
      <header className="sticky top-0 z-30 border-b border-[rgba(255,255,255,0.06)] px-6 py-3"
        ...
        <div className="max-w-5xl mx-auto flex items-center gap-3">
          ...
          <Chrome className="w-4 h-4 text-[#5B8DEF]" />
          <span className="text-sm font-bold tracking-[0.18em] text-[#5B8DEF]">BROWSER EXTENSION</span>
        </div>
      </header>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-5"
            ...
            <span className="w-1.5 h-1.5 rounded-full bg-[#5B8DEF]"
              style={{ animation: 'pulse 1.2s ease-in-out infinite', boxShadow: '0 0 8px #5B8DEF' }} />
            <span className="text-[10px] font-black tracking-[0.25em] uppercase text-[#5B8DEF]">CHROME · EDGE · BRAVE</span>
          </div>
          <h1 className="font-black tracking-tight mb-4" style={{ fontSize: 'clamp(2.5rem, 5.5vw, 4.5rem)', lineHeight: 1 }}>
            ...
            <br />
            <span style={{ background: 'linear-gradient(90deg, #5B8DEF 0%, #10D982 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Screen anywhere.
            </span>
          </h1>
        ...
        <div className="rounded-2xl p-6 mb-10"
          style={{
            background: 'linear-gradient(135deg, rgba(91,141,239,0.05) 0%, rgba(16,217,130,0.03) 100%)',
            border: '1px solid rgba(91,141,239,0.3)',
            boxShadow: '0 0 40px rgba(91,141,239,0.08)',
          }}>
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center shrink-0"
              style={{ background: 'linear-gradient(135deg, #5B8DEF 0%, #2c6bbd 100%)', boxShadow: '0 0 28px rgba(91,141,239,0.5)' }}>
            ...
            <a href="/api/extension/download" download
              ...
              style={{ background: 'linear-gradient(135deg, #5B8DEF 0%, #2c6bbd 100%)', color: '#fff', boxShadow: '0 0 20px rgba(91,141,239,0.4)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={s.n} className="rounded-xl p-5"
                style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(91,141,239,0.18)' }}>
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-xs font-black tabular-nums px-2 py-1 rounded"
                    style={{ background: 'rgba(91,141,239,0.1)', color: '#5B8DEF', border: '1px solid rgba(91,141,239,0.4)' }}>{s.n}</span>
                  <s.Icon className="w-4 h-4 text-[#5B8DEF]" />
                </div>
        ...
        <section className="rounded-2xl p-6 mb-10"
          ...
          <div className="text-[10px] uppercase tracking-[0.25em] text-[#5B8DEF] font-black mb-3">INSTALL (DEV MODE)</div>
          <ol className="space-y-3 text-[12px] text-[rgba(255,255,255,0.75)] leading-relaxed">
            <li><span className="font-black text-white">1.</span> Click <span className="text-[#5B8DEF] font-bold">Download</span> above — saves a .zip with the extension files</li>
            <li><span className="font-black text-white">2.</span> Unzip somewhere persistent (e.g. <code className="text-[#10D982] font-mono text-[11px]">~/Documents/genesis-swarm-extension</code>)</li>
            <li><span className="font-black text-white">3.</span> Open <code className="text-[#10D982] font-mono text-[11px]">chrome://extensions</code> (or <code className="text-[#10D982] font-mono text-[11px]">edge://extensions</code>, <code className="text-[#10D982] font-mono text-[11px]">brave://extensions</code>)</li>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            <div key={f.t} className="rounded-lg p-4"
              style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <f.Icon className="w-4 h-4 text-[#5B8DEF] mb-2" />
