...
// (sent question + fund context to Groq). No replacement — Genesis Swarm does not
// produce legal opinions.

const GONE = {
  error: 'gone',
  message: 'Retired — Genesis Swarm does not generate legal opinions. The deterministic scanner at /scan flags breaches; a qualified adviser interprets them.',
}
